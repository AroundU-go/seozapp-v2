...
export type AiEngineId = 'chatgpt' | 'perplexity' | 'anthropic' | 'grok' | 'kimi' | 'gemini';
...
export const AI_ENGINES: Record<AiEngineId, AiEngineInfo> = {
  ...
  kimi: {
    ...
    iconPath: '/icon5.png',
    badgeBg: 'bg-[#5d2a1a]/10',
    badgeText: 'text-[#5d2a1a]',
  },
  gemini: {
    id: 'gemini',
    name: 'Gemini',
...
export const AiEngineBadge: React.FC<{ engineId: AiEngineId; showProvider?: boolean }> = ({
  ...
  const engine = AI_ENGINES[engineId] || AI_ENGINES.kimi;
